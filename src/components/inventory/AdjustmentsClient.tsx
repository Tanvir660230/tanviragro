...
export function AdjustmentsClient({ adjustments }: { adjustments: AdjustmentRow[] }) {
  ...
  const columns: GridColumn<AdjustmentRow>[] = useMemo(() => [
    ...
    {
      id: "type", header: "Direction", accessorKey: "type", sortable: true, filterable: true,
      filterType: "select", priority: 2,
      filterOptions: [
        { label: "Surplus (+)", value: "adjustment_in" },
        { label: "Shortage (−)", value: "adjustment_out" },
      ],
      cell: ({ row }) => {
        ...
        return (
          <span className={cn("inline-flex items-center gap-1.5 rounded-full border px-2.5 py-0.5 text-xs font-semibold",
            ...
            {isIn ? "Surplus" : "Shortage"}
          </span>
        );
      },
    },
    {
      id: "reason", header: "Reason", accessorKey: "notes", sortable: false, filterable: true,
      ...
      cell: ({ row }) => (
        <span className="text-xs font-medium text-foreground bg-muted/60 rounded-md px-2 py-0.5">
          {parseReason(row.notes)}
        </span>
      ),
    },
    {
      id: "qty", header: "Quantity", accessorKey: "qty", sortable: true, filterable: true,
    ...
    {
      id: "recorded_at", header: "Date", accessorKey: "recorded_at", sortable: true,
    ...
    {
      id: "notes", header: "Notes", accessorKey: "notes", sortable: false, filterable: false, priority: 7,
  ...
  return (
    <div className="space-y-4">
      <div className="grid grid-cols-3 gap-3">
        <div className="rounded-2xl border border-border/70 bg-card p-4">
          <div className="flex items-center gap-2 mb-1">
            ...
            <span className="text-xs font-medium text-muted-foreground">Total Adjustments</span>
          </div>
        ...
        <div className="rounded-2xl border border-emerald-500/20 bg-emerald-500/5 p-4">
          <div className="flex items-center gap-2 mb-1">
            ...
            <span className="text-xs font-medium text-emerald-600">Surplus</span>
          </div>
        ...
        <div className="rounded-2xl border border-rose-500/20 bg-rose-500/5 p-4">
          <div className="flex items-center gap-2 mb-1">
            ...
            <span className="text-xs font-medium text-rose-600">Shortage</span>
          </div>
      ...
      <EnterpriseDataGrid
        ...
        subtitle={`${adjustments.length} stock adjustments · physical counts, spoilage, damage & corrections`}
        enableGlobalSearch
        ...
        emptyDescription="Stock adjustments from physical counts, spoilage or corrections will appear here."
