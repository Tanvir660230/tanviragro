...
export async function AppSidebarWrapper() {
  ...
  if (!user) return <AppSidebar isAdmin={false} business={null} role="viewer" />;
  ...
  const role = ((roleData as { role?: string; business_id?: string } | null)?.role as ExtendedUserRole) || "owner";
