...
| 9.8 | FEED | P0 | Feed costing & inventory ledger (no auto-deduction, one accounting path, WAC, units, audited corrections) | CODE DONE, UNCOMMITTED; production migration not applied. See docs/FEED_COSTING_IMPLEMENTATION_REPORT.md |
